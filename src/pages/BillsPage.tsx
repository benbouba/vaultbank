      ...
      <div className="max-w-md mx-auto space-y-5">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Distribution Company (DISCO)</label>
              <select
                value={disco}
                onChange={(e) => setDisco(e.target.value)}
                className="w-full px-4 py-5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 bg-white"
              >
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Meter Number</label>
              <input
                type="tel"
                value={meter}

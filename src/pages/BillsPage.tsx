      ...
      <div className="max-w-md mx-auto space-y-4">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Distribution Company (DISCO)</label>
              <select
                value={disco}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Meter Number</label>
              <input
                type="tel"
                value={meter}
